...
const MainPageRecentTrackList = ({ 
  tracks, 
  expandedSection,
  onExpandSection,
  onTrackSelect 
}) => {
  const isExpanded = expandedSection === 'recentTracks';
    ...
    <div className="mb-12">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-purple-400">Your recently listened to songs</p>
        </div>
        <div className="flex items-center gap-4">
          <motion.button
            onClick={() => onExpandSection(isExpanded ? null : 'recentTracks')}
...
export default MainPageRecentTrackList;
